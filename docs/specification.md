...
- Наличие полного пакета договоров/документов не является блокером перехода в Approved
- Исполнение заказа (ввод фактических дат этапов) может начинаться до получения всех договоров/документов
- Договоры и документы могут дозагружаться в процессе сопровождения заказа
