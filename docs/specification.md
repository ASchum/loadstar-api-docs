...
- **`is_route_negotiated`** (логический флаг, default: false)
  ...
  - **Заполняет:** Система (автоматически после завершения согласования в чате) или Supervisor (ручной флип)
...
| **Кто может устанавливать** | Система (после согласования в чате) или Supervisor вручную флипает | Только Ops (по своим запросам) или Supervisor (по любым) через отдельное действие |
| **Предусловия установки** | Есть сообщения в чате согласования; логист ответил "OK" | ≥1 маршрутный этап, ≥1 тип ТС, основные поля заполнены |
