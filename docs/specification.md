...
**Frontend:**
- Backend всегда отправляет даты в UTC
- Frontend конвертирует в локальное время пользователя для отображения
- Для российских пользователей: UTC+3 (Московское время)
- Используется `Intl.DateTimeFormat` или библиотеки типа `date-fns-tz`, `luxon`

**Пример:**
```javascript
// Backend → Frontend (UTC)
"created_at": "2026-02-17T10:30:00Z"

// Frontend отображает для пользователя в Москве (UTC+3)
"17.02.2026 13:30" 

// При отправке обратно в Backend - конвертировать в UTC
```
